...
$(function() {
	...
	function init() {
		...
		setTimeout(function() {
			$('.wallet__lines').addClass('show-lines');
		}, 1500)
	...
	$(window).on('scroll', function() {
		...
		var steps = new Waypoint({
			element: document.querySelector('.steps__item--1'),
			handler: function (direction) {
	...
	var counter = new Vue({
		...
		methods: {
			...
			setNowPoints: function() {
				...
				this.nowPoints = this.startPoints + ((now - this.enterDate) / 1000) * this.pointsPerSecond;
				this.nowClients = this.startClients + ((now - this.enterDate) / (1000 * 60 * 60)) * this.clientsPerHour;
				
				this.setRandomInterval();
				setTimeout(this.setNowPoints, this.interval);
			},
			setStartPoints: function () {
				var now = new Date();

				this.startPoints = ((now - this.startDate) / 1000) * this.pointsPerSecond;
				this.startClients = ((now - this.startDate) / (1000 * 60 * 60)) * this.clientsPerHour;
				this.nowPoints = this.startPoints;
				this.nowClients = this.startClients;
			},
		...
		created: function() {
			...
			hours = this.enterDate.getHours();

			if (hours >= 0 && hours <= 7) {
				this.pointsPerSecond = 0.5;
				this.clientsPerHour = 1;
			}	
		},
		mounted: function() {
			this.setStartPoints();
