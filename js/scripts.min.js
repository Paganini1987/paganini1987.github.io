...
$(function() {
	...
	$('.js-standard').attr('href', 'https://appl.unicredit.ru/credit_cards?product_type=MC_Standard' + postfix);
	$('.js-gold').attr('href', 'https://appl.unicredit.ru/credit_cards?product_type=MC_Gold' + postfix);
