// Структура файла scripts.min.js:
...
//Анимации появления и ухода со слайдов

function enterFirst() {
    //Анимация появления элементов на первом слайде
    ...
    slide1
        ...
        .set('.banner__title, .banner__text, .banner__item, .cards__gold, .cards__standard, .cards__shadow', {
            transform: 'translateY(-70px)',
            opacity: 0
        }, 'start')
        .to('.banner__title, .banner__text', 1, {
            transform: 'translateY(0)',
            opacity: 1
        }, 'start')
        .to('.banner__item--1', 1, {
...
//2 слайд Выбор карты
function secondEnterFromFirst(speed) {
    var secondEnterFromFirst = new TimelineMax();

    secondEnterFromFirst
        .set('.select__text, .select__title', {
            opacity: 0
        })
        .set('.select__cards', {
        ...
        .to('.select__text, .select__title', speed, {
            opacity: 1
        }, '+=1')
        .to('.select__cards', speed, {
            transform: 'translateY(0px)',
            opacity: 1
        }, '-=1')

}
function secondLeaveToFirst(speed) {
    var secondLeaveToFirst = new TimelineMax();
...
function fourthEnter(speed) {
    var fourthEnter = new TimelineMax();

    fourthEnter
        .set($('.wave1'), {
            attr: {
                d: 'M 0 480 C 200 480 280 280 480 280 C 680 280 760 360 1000 360 C 1240 360 1360 120 1600 120 C 1800 120 1840 160 1920 200'
            }
        })
        .set($('.wave1_2'), {
            attr: {
                d: 'M 0 487 C 200 487 280 287 480 287 C 680 287 760 367 1000 367 C 1240 367 1360 127 1600 127 C 1800 127 1840 167 1920 207'
            }
        })
        .set($('.wave1_3'), {
            attr: {
                d: 'M 0 494 C 200 494 280 294 480 294 C 680 294 760 374 1000 374 C 1240 374 1360 134 1600 134 C 1800 134 1840 174 1920 214'
            }
        })
        .set($('.wave2'), {
            attr: {
                d: 'M 0 400 C 80 400 240 520 480 440 C 720 360 760 200 1000 200 C 1240 200 1280 280 1480 280 C 1720 280 1840 80 1920 80'
            }
        })
        .set($('.wave2_2'), {
            attr: {
                d: 'M 0 407 C 80 407 240 527 480 447 C 720 367 760 207 1000 207 C 1240 207 1280 287 1480 287 C 1720 287 1840 87 1920 87'
            }
        })
        .set($('.wave2_3'), {
            attr: {
                d: 'M 0 414 C 80 414 240 534 480 454 C 720 374 760 214 1000 214 C 1240 214 1280 294 1480 294 C 1720 294 1840 94 1920 94'
            }
        })
        .set($('.back'), {
            attr: {
                d: 'M 0 400 Q 80 440 240 440 C 520 400 560 200 800 200 C 1000 200 1080 320 1320 320 C 1600 280 1640 80 1920 80 L 1920 2000 L 0 2000 Z'
            }
        })
        .set($('.get__item'), {
        ...
        .set($('.get__text, .get__title'), {
            opacity: 0
        })
        .to($('.get__text, .get__title'), speed, {
            opacity: 1
        })

        .to($('.get__item--1'), speed / 2, {
            transform: 'translateY(0px)',
            opacity: 1
        }, '-=0.7')
        .to($('.get__item--2'), speed / 2, {
            transform: 'translateY(0px)',
            opacity: 1
        }, '-=0.2')
        .to($('.get__item--3'), speed / 2, {
            transform: 'translateY(0px)',
            opacity: 1
        }, '-=0.2')
...
//     TweenMax.to($('.wave1'), 5, {
//         attr: {
//             d: 'M 0 485 C 200 455 280 250 480 250 C 680 285 760 365 1000 365 C 1240 365 1360 125 1600 125 C 1800 125 1840 165 1920 205'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
//     });
//     TweenMax.to($('.wave1_2'), 5, {
//         attr: {
//             d: 'M 0 492 C 200 462 280 257 480 257 C 680 292 760 372 1000 372 C 1240 372 1360 132 1600 132 C 1800 132 1840 172 1920 212'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
//     });
//     TweenMax.to($('.wave1_3'), 5, {
//         attr: {
//             d: 'M 0 499 C 200 469 280 264 480 264 C 680 299 760 379 1000 379 C 1240 379 1360 139 1600 139 C 1800 139 1840 179 1920 219'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
...
//     TweenMax.to($('.wave2'), 5, {
//         attr: {
//             d: 'M 0 400 C 80 400 240 520 480 440 C 720 360 760 200 1000 200 C 1240 300 1280 300 1480 300 C 1720 280 1840 80 1920 80'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
//     });
//     TweenMax.to($('.wave2_2'), 5, {
//         attr: {
//             d: 'M 0 407 C 80 407 240 527 480 447 C 720 367 760 207 1000 207 C 1240 214 1280 307 1480 307 C 1720 287 1840 87 1920 87'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
//     });
//     TweenMax.to($('.wave2_3'), 5, {
//         attr: {
//             d: 'M 0 414 C 80 414 240 534 480 454 C 720 374 760 214 1000 214 C 1240 221 1280 314 1480 314 C 1720 294 1840 94 1920 94'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
...
//     TweenMax.to($('.back'), 5, {
//         attr: {
//             d: 'M 0 400 Q 80 440 240 440 C 520 450 560 250 800 250 C 1000 200 1080 320 1320 320 C 1600 280 1640 80 1920 80 L 1920 2000 L 0 2000 Z'
//         },
//         yoyo: true,
//         repeat: 999,
//         ease: 'Linear.easeNone'
...
function fourthLeave(speed) {
    var waves = new TimelineMax();

    waves
        .add('start')
        .to($('.wave1, .wave1_2, .wave1_3'), speed, {
            attr: {
                d: 'M 0 480 C 200 480 280 480 480 480 C 680 480 760 480 1000 480 C 1240 480 1360 480 1600 480 C 1800 480 1840 480 1920 480'
            }
        })
        .to($('.wave2, .wave2_2, .wave2_3'), speed, {
                attr: {
                    d: 'M 0 480 C 80 480 240 480 480 480 C 720 480 760 480 1000 480 C 1240 480 1280 480 1480 480 C 1720 480 1840 480 1920 480'
                }
            })
        .to($('.back'), speed, {
            attr: {
                d: 'M 0 480 Q 80 480 240 480 C 520 480 560 480 800 480 C 1000 480 1080 480 1320 480 C 1600 480 1640 480 1920 480 L 1920 2000 L 0 2000 Z'
            }
        })
    // TweenMax.to($('.get__text, .get__title, .get__item'), speed, {
    //     opacity: 0
    // });
}

//Слайд Тарифы
function fifthLeave(speed) {
    TweenMax.to($('.rates__text, .rates__title, .rate'), speed, {
        opacity: 0
    });
}

function fifthEnter(speed) {
    var fifthEnter = new TimelineMax();

    fifthEnter
        .set($('.rates__text, .rates__title'), {
            opacity: 0
        })
        .to($('.rates__text, .rates__title'), speed, {
            opacity: 1
        }, '+=0.5')
        .to($('.rate'), speed, {
            opacity: 1
...
//Слайд Совершайте покупки
function sixthLeave(speed) {
    var sixthLeave = new TimelineMax();

    sixthLeave
        .to('.buy__text, .buy__title, .buy__icons', speed, {
            transform: 'translateY(-50px)',
            opacity: 0
        })
        .to('.phone__card, .phone__shadow', speed, {
            transform: 'translateY(-150px)',
            opacity: 0
        })
        .to('.buy__note, .footer', speed, {
            transform: 'translateY(1000px)'
        })
}
function sixthEnter(speed) {
    var sixthEnter = new TimelineMax();

    sixthEnter
        .add('start')
        .set('.phone__card, .phone__shadow', {
            transform: 'translateY(-150px)',
            opacity: 0
        })
        .to('.phone__card, .phone__shadow', 1, {
            transform: 'translateY(0px)',
            opacity: 1
        }, '+=0.5')
        .to('.phone__phone', 1, {
    ...
    sixthEnter.eventCallback("onStart", function() {
        //Анимация отрисовки телефона
        var myVivus;

        myVivus = new Vivus('phone', { duration: 100 });
...
$(function() {
	...
	//Parallax эффект у карт
	parallax('.header', [{ obj: '.cards__gold', mov: '-40' },{ obj:'.cards__standard', mov: '-20' }]);

	//Parallax эффект на последнем слайде
	parallax('.buy', [{ obj: '.phone__card', mov: '-40' }, { obj: '.phone__phone', mov: '-20' }]);

	//Заявка
	$('.js-checkout').on('click', function () {
		$('body').addClass('modal-opened');
		var postfix = '?' + window.location.search.substring(1).split("&").join("&"),
			cardType = $(this).data('card');

		//console.log(postfix);

		if (cardType == 'gold') {
			iframe_src = 'https://form.unicreditbank.ru/ru/personal/banking/packages-app-embed-mastercard-gold.html' + postfix;
		}
		if (cardType == 'standard') {
			iframe_src = 'https://form.unicreditbank.ru/ru/personal/banking/packages-app-embed-mcs.html' + postfix;
		}

		$('#modal-iframe').prop('src', iframe_src);
	});
	...
	//Плавная смена цвета градиента при выборе карты

	function gradientSet(oldG, newG) {
		var color0 = oldG[0],
			color1 = oldG[1],
			color2 = oldG[2],
			color0_n = newG[0],
		...
		colorCounter(color0, color0_n, setColor.bind(null, oldG, 0))
		colorCounter(color1, color1_n, setColor.bind(null, oldG, 1))
		colorCounter(color2, color2_n, setColor.bind(null, oldG, 2))
	}

	function colorCounter(oldC, newC, fn) {
		if (oldC == newC) {
			return null;
		}
		...
		if (oldC > newC) {
			setTimeout(colorCounter.bind(this, oldC - 1, newC, fn), 2);
		} else {
			setTimeout(colorCounter.bind(this, oldC + 1, newC, fn), 2);
		}
	}

	function setColor(arr, index, color) {
		arr[index] = color;
	}

	//-----------------------------------

	//Обновить страницу при ресайзе
	var resize = true,
		windowWidth = $(window).width();

	$(window).on('resize', function () {
		if (resize && $(window).width() != windowWidth) {
	...
	function parallax(obj, targets) {
		...
		function callParallax(e) {
			targets.forEach(function(target) {
				parallaxIt(e, target.obj, target.mov);
			})
		}
	...
	//Кнопка Оформить карту на первом экране
	$('.js-p-action-open').on('click', function(e) {
		e.preventDefault();

		$('body').addClass('p-action-show');
	})

	//Закрыть попап
	$('.js-p-action-close').on('click', function(e) {
		e.preventDefault();

		$('body').removeClass('p-action-show');
	})
	$('body').on('click', function (e) {
		if ($(e.target).hasClass('p-action__wrapper')) {
			$('body').removeClass('p-action-show');
		}
	})
	...
	var selector = {
		...
		selectCard: function (card) {
			...
			if (this.activeCard == 'gold') {
				$('.phone__card img').attr('src', 'img/icons/-e-card_pay_gold.png');
				$('body').removeClass('selected-standard');
				$('body').addClass('selected-gold');

				this.button.data('card', 'gold');
				this.button.text('Оформить карту GOLD');
				gradientSet(colors[0], [118, 68, 146]);
			}
			if (this.activeCard == 'standard') {
				$('.phone__card img').attr('src', 'img/icons/-e-card_pay_standart.png');
				$('body').removeClass('selected-gold');
				$('body').addClass('selected-standard');

				this.button.data('card', 'standard');
				this.button.text('Оформить карту CLASSIC');
				gradientSet(colors[0], [49, 112, 171]);
			}
		},
		hoverCard: function (card) {
			if (card == 'standard' && this.activeCard == 'gold') {
				$('.js-gold').css('transform', 'scale(1)');
			}
			if (card == 'gold' && this.activeCard == 'standard') {
				$('.js-standard').css('transform', 'scale(1)');
			}
		},
		hoverCardR: function (card) {
			if (card == 'standard' && this.activeCard == 'gold') {
				$('.js-gold').css('transform', 'scale(1.1)');
			}
			if (card == 'gold' && this.activeCard == 'standard') {
				$('.js-standard').css('transform', 'scale(1.1)');
			}
		}
	}

	//Умньшение противоположной карты при наведении
	$('.select__card label').on('mouseenter', function (e) {
		var card = $(this).data('card');

		selector.hoverCard(card);
	})
	$('.select__card label').on('mouseleave', function (e) {
		var card = $(this).data('card');

		selector.hoverCardR(card);
	})

	//Выбор карты, анимация градиента выбора карты на втором слайде
	$('.select__card input').on('change', function () {
		if ($(this).prop('checked') == true) {
			var type = $(this).data('card');

			//Выбор карты
			selector.selectCard(type);
		}
	})

	//Скролл до таблицы сравнения при клике на любой карте
	$('.select__card input').on('click', function () {
		if (dAnchor) {
			if ($(window).width() > 640) {
				$('html, body').animate({ scrollTop: $('.js-show-button').offset().top - secondHeight - 50 }, 1000)
			} else {
				$('html, body').animate({ scrollTop: $('.js-show-button').offset().top - secondHeight640 - 20 }, 1000)
			}
		}
	})

	//Установка карты по умолчанию
	selector.selectCard('gold');
});
...
function cardsAnimate() {
	//After 640 px
	var secondLeave_ = new TimelineMax();

	secondHeight = $('.select__img').outerHeight() * 0.4 + $(window).height() * 0.04;
	secondHeight = Math.round(secondHeight);

	secondLeave_
		.add('start')
		.to('.select__center', 1.5, {
			height: secondHeight
		})
		.to('.compare', 1, {
			//paddingTop: secondHeight,
		})
		.to('.select__text, .select__title', 0.5, {
			transform: 'translateY(-100px)',
			opacity: 0
		}, 'start')
		.to('.select__card', 1.8, {
		...
		.to('.select__cards', 0.3, {
			marginTop: 0
		}, 'start')
		.to('.select__description', 0.5, {
			opacity: 0,
		}, 'start')
		.to('.select__tm', 0.5, {
			visibility: 'visible',
	...
	//Before 640
	var secondLeave640_ = new TimelineMax();

	secondHeight640 = $('.select__card').outerHeight() + $(window).height() * 0.04 - 15;
	secondHeight640 = Math.round(secondHeight640);

	secondLeave640_
		.add('start')
		.to('.select__center', 1, {
			height: secondHeight640
		})
		.to('.compare', 1, {
			//paddingTop: secondHeight640
		})
		.to('.select__text, .select__title', 0.5, {
			transform: 'translateY(-100px)',
			opacity: 0.5
		}, 'start')
		.to('.select__text, .select__title', 0.2, {
			transform: 'translateY(-100px)',
			opacity: 0
		})
		.to('.select__cards', 0.5, {
			//transform: 'translateY(' + ($('.select__h').height() + 15) + 'px)',
			marginTop: 0
		}, 'start')
		.to('.select__description', 0.2, {
			marginBottom: 0,
		})

	var menu = TweenMax.to($('.select'), 0.5, {
		transform: 'translateY(-300px)'
	});

	//Отключение якоря к списку при уменьшенных картах
	secondLeave_.eventCallback("onComplete", disableAnchor);
	secondLeave640_.eventCallback("onComplete", disableAnchor);

	//Включение якоря к списку при уменьшенных картах
	secondLeave_.eventCallback("onReverseComplete", enableAnchor);
	secondLeave640_.eventCallback("onReverseComplete", enableAnchor);
	...
	// create a scene
	if ($(window).width() > 640) {
		var scene = new ScrollMagic.Scene({ triggerElement: "#select", duration: '70%', triggerHook: 'onLeave' })
			.setTween(secondLeave_)
			.addTo(controller);
		secondLeave640_.pause();
	} else {
		var scene640 = new ScrollMagic.Scene({ triggerElement: "#select", duration: '50%', triggerHook: 'onLeave' })
			.setTween(secondLeave640_)
			.addTo(controller);
		secondLeave_.pause();
	}

	var scene2 = new ScrollMagic.Scene({ triggerElement: "#select", duration: '450%', triggerHook: 'onLeave' })
		.setPin(".select", { pushFollowers: false })
		.addTo(controller);

	var hiddenMenu = new ScrollMagic.Scene({ triggerElement: ".compare__item--last", duration: '1', triggerHook: 'onLeave' })
		.setTween(menu)
		.addTo(controller);

	var compareListHeight = $('.compare__list').height() + 50,
		buttonHeight = $('.button').height();

	var checkoutButton = new ScrollMagic.Scene({ triggerElement: ".button", duration: (compareListHeight + buttonHeight), triggerHook: 'onEnter', offset: buttonHeight })
		.setPin(".button", { pushFollowers: false })
		//.addIndicators({ name: "2 (duration: 500)" })
		.addTo(controller);

	var sButton = TweenMax.to($('.compare__button'), 2, {
		width: '20%',
		borderRadius: '5px'
	});

	var checkoutButtonSmall = new ScrollMagic.Scene({ triggerElement: ".get", duration: "100%", triggerHook: 'onEnter' })
		.setTween(sButton)
		//.addIndicators({ name: "2 (duration: 500)" })
		.addTo(controller);
	...
	waves
		.add('start')
		.to($('.wave1, .wave1_2, .wave1_3'), 5, {
			attr: {
				d: 'M 0 480 C 200 480 280 480 480 480 C 680 480 760 480 1000 480 C 1240 480 1360 480 1600 480 C 1800 480 1840 480 1920 480'
			}
		}, 'start')
		.to($('.wave2, .wave2_2, .wave2_3'), 5, {
			attr: {
				d: 'M 0 480 C 80 480 240 480 480 480 C 720 480 760 480 1000 480 C 1240 480 1280 480 1480 480 C 1720 480 1840 480 1920 480'
			}
		}, 'start')
	...
	var waves = new ScrollMagic.Scene({ triggerElement: ".get", duration: '50%', triggerHook: 'onLeave' })
		.setTween(waves)
		.addTo(controller);
	...
	//Анимация слайда Как получить
	var get = new ScrollMagic.Scene({ triggerElement: ".get__container", duration: "0" })
		.setTween(fourthEnter)
		.addTo(controller);
	...
	fifthEnter.eventCallback("onComplete", function() {
		
	});

	//Parallax эффект условия
	$('.rate__wrap').tilt({
		maxTilt: 2,
		disableAxis: 'x'
	})
	
	//Анимация слайда Условия
	var rates = new ScrollMagic.Scene({ triggerElement: ".rates__container", duration: "0", triggerHook: "0.9" })
		.setTween(fifthEnter)
		.addTo(controller);
	...
	//Анимация слайда Совершайте покупки
	var rates = new ScrollMagic.Scene({ triggerElement: ".buy__container", duration: "0", triggerHook: "0.6" })
		.setTween(sixthEnter)
		.addTo(controller);
