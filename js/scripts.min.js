...
$(function() {
	...
	var get = new Waypoint({
		element: document.querySelector('.get__text'),
	...
	var rates = new Waypoint({
		element: document.querySelector('.rates__text'),
		handler: function (direction) {
			fifthEnter(1);
	...
	var buy = new Waypoint({
		element: document.querySelector('.buy__text'),
		handler: function (direction) {
			sixthEnter(1);
...
function cardsAnimate() {
	...
	console.log(compareListHeight, buttonHeight);
