	...
	function setData(data) {
		if (data) {
			...
			if (data[randomIndex] && viewedIndexes.indexOf(randomIndex) < 0) {
				...
				$('.p-prediction__center').css('background-image', 'url(' + data[randomIndex].img +')')
				...
				//FB sharing
				shareOverrideOGMeta('Юняша предсказала мне: ' + data[randomIndex].text, 'Узнайте ваше предсказание и выигрывайте денежные призы.', window.location.href + data[randomIndex].img)
				...
				console.log(window.location.href + data[randomIndex].img);
				
				$('.p-prediction__button').html();
				$('.p-prediction__button').append(vkButton);
