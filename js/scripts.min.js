...
function sixthEnter(speed) {
    ...
    myVivus = new Vivus('phone', { duration: 500, type: 'oneByOne' });
...
$(function() {
	...
	$('#fullpage').fullpage({
		...
		onLeave: function (index, nextIndex, direction) {
			...
			//Скрыть кнопку при уходе с 3 слайда
			if (index == 3) {
				$('.compare__button').removeClass('show-button');
				$('.js-checkout').removeClass('button-small');
			}

			//Анимация при заходе на слайд Способы
			if (nextIndex == 4) {
				fourthEnter(1);
			}
			//Анимация при уходе со слайда Способы
			if (index == 4) {
				fourthLeave(1);
			}

			//Анимация при заходе на слайд Тарифы
			if (nextIndex == 5) {
				fifthEnter(1);
			}
			//Анимация при уходе со слайда Тарифы
			if (index == 5) {
				fifthLeave(1);
			}

			//Анимация при заходе на слайд Совершайте покупки
			if (nextIndex == 6) {
				sixthEnter(1);
			}
			//Анимация при уходе со слайда Совершайте покупки
			if (index == 6) {
				sixthLeave(1)
			}
