...
$(function() {
	...
	$('a.scroll').on('click', function (e) {
		...
		if (this.hash == '#conditions') {
			$('html, body').animate({ scrollTop: Math.round(target_offset) - ($(window).height() - $(this.hash).height())+93 }, 500);

			return null;
		}
		$('html, body').animate({ scrollTop: Math.round(target_offset) - customoffset }, 500);
	});
});