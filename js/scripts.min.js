...
function init() {
	...
	parallax('.tile', [{ obj: '.tile__card', mov: '-15' }, { obj: '.tile__coin-big', mov: '-15' }, { obj: '.tile__coin-small', mov: '-15' }, { obj: '.tile__bag', mov: '-5' }], 'x');
	...
	var smoke1 = new Vivus('smoke-1');
	var smoke2 = new Vivus('smoke-2');
...
$(function() {
	...
	function showCategory(category) {
		...
		if (category === 'Магазины IKEA') {
			$('.cards__categories').removeClass('show-all');
		}
	}
