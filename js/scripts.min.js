...
$(function() {
	...
	window.onscroll = function () { stickyOnOff () };

	var select = document.querySelector(".select"),
		body = document.querySelector("body");

	var sticky = select.offsetTop;

	function stickyOnOff() {
		if (window.pageYOffset > sticky) {
			$('body').addClass('card-opacity');
		} else {
			$('body').removeClass('card-opacity');
		}
	}
	...
	var goldGradient = $('.gold-gradient'),
		standardGardient = $('.standard-gradient');
	...
	//Умньшение противоволожной карты при наведении
	$('.select__card label').on('mouseenter', function(e){
		var card = $(e.target).closest('label').data('card');
	...
	function secondEnter() {
		if ($(window).width() > 640) {
			secondLeave_.timeScale(1.5);
			secondLeave_.reverse();
		} else {
			secondLeave640_.reverse();
		}
	}

	function secondLeave() {
		if ($(window).width() > 640) {
			secondLeave_.timeScale(1);
			secondLeave_.play();	
		} else {
			secondLeave640_.play();
		}
