				...
				<div class="col-md-12">
					<div class="filters__inner">
						...
						<div v-if="currentCategory.isSet || !isAdditional" class="filters__group">
							...
							<drop-down is-large label="Ваше меню" :list="categoriesList" :current-value="proxyCurrentCategory" @change-value="setCategory"></drop-down>
						...
						<button v-if="isAdditional && currentCategory.isSet" class="filters__button filters__button--add filters__button--hidden-on-mobile df-btn df-btn--large df-btn--bordered">
...
import DropDown from './FiltersDropdown.vue'
